...
// RESET PULSE DETECTION ----------------------------------------------------------------------------------------  Uses PB0 as input
        ...
        TCNT0 = 0;                                  //reset Timer1 to 0, each tick is 4us on the Nano, 8Mhz Attiny with /8 prescale will be 1us per tick
				uint16_t time0 = TCNT0;                     //timestamp of detected LOW, needs to be 16-bit to match the timer, 8 bit timer overflows at 1024us maybe use 8-bit?
				waitForHigh();
